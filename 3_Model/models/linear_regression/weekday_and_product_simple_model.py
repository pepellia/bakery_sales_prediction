"""
Linear Regression Model with Weekday and Product Group Features

This script implements a simple linear regression model using only:
- Weekday (Wochentag)
- Product Group Name (Warengruppe_Name)
"""
...
def main():
    ...
    feature_columns = ['Wochentag', 'Warengruppe']
