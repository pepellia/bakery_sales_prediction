...
MODEL_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(SCRIPT_DIR)))  # 3_Model directory
...
# Define paths
MODEL_NAME = 'linear_regression_v11'  # Updated to v11
...
def load_data():
    ...
    submission_df = pd.read_csv(os.path.join(MODEL_OUTPUT, 'submission_v11.csv'))  # Updated to v11
